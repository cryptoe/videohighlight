...
function listTweets(data) {
	...
	jQuery(document).ready(function() {
		...
		if(jQuery("#s").val()!=""){
					var cc = new CanvasCarousel("myCanvas", "http://wedup.net/circle.php?id="+jQuery("#sapakID").val()+"&s="+jQuery("#s").val()+"&hasPortfolioMovies="+jQuery("#hasPortfolioMovies").val()+"&hasPortfolioImages="+jQuery("#hasPortfolioImages").val()+"&w=320&height=250");
					var cc2 = new CanvasCarousel("myCanvas2", "http://wedup.net/circle.php?id="+jQuery("#sapakID").val()+"&s="+jQuery("#s").val()+"&hasPortfolioMovies="+jQuery("#hasPortfolioMovies").val()+"&hasPortfolioImages="+jQuery("#hasPortfolioImages").val()+"&w=480&height=290");
				}
				else{
					var cc = new CanvasCarousel("myCanvas", "http://wedup.net/circle.php?id="+jQuery("#sapakID").val()+"&hasPortfolioMovies="+jQuery("#hasPortfolioMovies").val()+"&hasPortfolioImages="+jQuery("#hasPortfolioImages").val()+"&w=320&height=250");
					var cc2 = new CanvasCarousel("myCanvas2", "http://wedup.net/circle.php?id="+jQuery("#sapakID").val()+"&hasPortfolioMovies="+jQuery("#hasPortfolioMovies").val()+"&hasPortfolioImages="+jQuery("#hasPortfolioImages").val()+"&w=480&height=290");
				}
        ...
        $(document).on('click', '#submit', function() { // catch the form's submit event
            if($('#username').val().length > 0){
                ...
                // action is functionality we want to call and outputJSON is our data
                    ...
                    $.ajax({url: 'http://wedup.net/info/checkuser.php',
