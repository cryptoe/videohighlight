...
function listTweets(data) {
	...
	jQuery(document).ready(function() {
		...
		if(jQuery("#s").val()!=""){
					var cc = new CanvasCarousel("myCanvas", "circle.php?id="+jQuery("#sapakID").val()+"&s="+jQuery("#s").val()+"&hasPortfolioMovies="+jQuery("#hasPortfolioMovies").val()+"&hasPortfolioImages="+jQuery("#hasPortfolioImages").val()+"&w=320&height=250");
					var cc2 = new CanvasCarousel("myCanvas2", "circle.php?id="+jQuery("#sapakID").val()+"&s="+jQuery("#s").val()+"&hasPortfolioMovies="+jQuery("#hasPortfolioMovies").val()+"&hasPortfolioImages="+jQuery("#hasPortfolioImages").val()+"&w=480&height=290");
				}
				else{
					var cc = new CanvasCarousel("myCanvas", "circle.php?id="+jQuery("#sapakID").val()+"&hasPortfolioMovies="+jQuery("#hasPortfolioMovies").val()+"&hasPortfolioImages="+jQuery("#hasPortfolioImages").val()+"&w=320&height=250");
					var cc2 = new CanvasCarousel("myCanvas2", "circle.php?id="+jQuery("#sapakID").val()+"&hasPortfolioMovies="+jQuery("#hasPortfolioMovies").val()+"&hasPortfolioImages="+jQuery("#hasPortfolioImages").val()+"&w=480&height=290");
				}
